...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/Google-Mobile-Ads-SDK-framework/GoogleMobileAdsResources.bundle"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/GoogleUserMessagingPlatform-framework/UserMessagingPlatformResources.bundle"
